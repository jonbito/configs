...
_G.packer_plugins = {
  ...
  gruvbox = {
    ...
    loaded = true,
    path = "/Users/arch/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/morhetz/gruvbox"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/arch/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
    url = "https://github.com/VonHeikemen/lsp-zero.nvim"
  },
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/Users/arch/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
