...
You are creating a focused technical feature document as a Markdown file for
direct implementation. Follow this systematic approach to create a well-scoped,
...
**Create a focused feature Markdown doc:**

1. Set the path using format: `docs/##-{feature name}/[Feature] {Feature Name}.md`. `##` should increment based on what's currently in the folder with zero padding
2. Use this template for the issue body:
...
- **Markdown Doc Created**: Path and full title
