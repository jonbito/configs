...
You are creating a comprehensive Product Requirements Document for a high-level product feature. Follow this systematic approach to create a thorough, well-researched PRD as a Confluence page.
...
## Step 4: Create Comprehensive Markdown Doc

**Create a new markdown doc with this structure:**

1. Set the path using format: `docs/##-{feature name}/[PRD] {Feature Name}.md`. `##` should increment based on what's currently in the folder with zero padding
2. Use this template for the page body:
...
- **Markdown Page Created**: path and full title
